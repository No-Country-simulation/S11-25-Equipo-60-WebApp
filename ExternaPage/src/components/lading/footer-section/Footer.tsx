...
export const Footer = () => {
  ...
  return (
    <footer className="bg-gray-600 text-blue-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-white text-lg font-bold mb-4">TestimoniApp</h3>
            <p className="text-sm mb-4">
              La plataforma líder para gestionar testimonios auténticos que impulsan tu negocio.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <a href="mailto:info@testimoniapp.com" className="hover:text-white transition-colors">
                  info@testimoniapp.com
                </a>
              </li>
              <li className="flex items-start">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
          <p>© {currentYear} TestimoniApp. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
